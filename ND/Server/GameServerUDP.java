...
public class GameServerUDP extends GameConnectionServer<UUID> 
{
	...
	// Informs clients that a remote client's avatar has changed orientation (yaw).
	// Message Format: (turn,remoteId,yaw)
	public void sendTurnMessages(UUID clientID, String yaw)
	{
		try 
		{
